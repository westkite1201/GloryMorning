    ...
    <div>
      <div className="dust_info_container">
        <div className="station_info">
          ...
          <div className="station_info_name">관측소 이름</div>
          <div className="station_info_addr">{dustInfoObject.addr}</div>
        </div>
        ...
        {!_.isNil(dustInfoObject[selectDustMessageInfo]) && (
          <div className="display_icon_wrapper">
            ...
            <div
              ...
              style={{ color: dustInfoObject[selectDustMessageInfo].color }}
            >
