...
export const updatePassword = (
  ...
  return axios.post("http://localhost:3031/api/user/updatePassword", data, {
...
export const updateMemberSosok = (mem_sosok_nm, mem_email) => {
  ...
  return axios.post("http://localhost:3031/api/user/updateMemberSosok", data, {
    headers: { "x-access-token": `${tokenStr}` }
  });
};
