...
export const searchPhotos = (query, page, per_page) => {
  const data = {
    query: query,
    page: page,
    per_page: per_page,
  };
  return axios.post(cilentConfig.endpoint.api + '/weather/searchPhotos', data);
};
...
export const getPixabayImages = (query, imageType) => {
  ...
  return axios.post(
    cilentConfig.endpoint.api + '/weather/getPixabayImages',
    data,
  );
};
...
export const getAreaRiseSetInfo = () => {
  ...
  return axios.post(
    cilentConfig.endpoint.api + '/weather/getAreaRiseSetInfo',
    data,
  );
};
...
export const getNearbyMsrstnList = (tmX, tmY) => {
  ...
  return axios.post(
    cilentConfig.endpoint.api + '/weather/getNearbyMsrstnList',
    data,
  );
};
...
export const getLocation = (locationA, locationB, locationC) => {
  ...
  return axios.post(
    cilentConfig.endpoint.api + '/weather/getLocation_chain',
    data,
  );
...
export const getWeatherDataPrivateMode = (nx, ny, shortTermYn) => {
  ...
  return axios.post(
    cilentConfig.endpoint.api + '/weather/getWeatherDataPrivateMode',
    data,
  );
};
...
export const getWeatherData = (nx, ny, category) => {
  ...
  return axios.post(
    cilentConfig.endpoint.api + '/weather/getWeatherData',
    data,
  );
  //return (axios.post("http://localhost:3031/api/member/test",data));
};
...
export const getWeatherDataShortTerm = (nx, ny) => {
  ...
  return axios.post(
    cilentConfig.endpoint.api + '/weather/getWeatherDataShortTerm',
    data,
  );
};
